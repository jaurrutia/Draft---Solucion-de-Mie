...
\section{ Matriz de esparcimiento general}
...
\end{align}
%
El campo eléctrico se calcula empleando la Ec. \eqref{eq:E=curlcurlA} con el resultado de la Ec. \eqref{eq:Hoscilante}; tras una manipulación algebráica (\ref{ex:Eoscilante}) podemos reescribir al campo eléctrico en una contribución de campo lejano (que decae como $1/r$) y de campo cercano (que decae como $r^{-n}$ con $n\geq 1$) como \cite{jackson1999electrodynamics} como
%
\begin{align}
...
%
	\begin{tcolorbox}[title = La matriz de esparcimiento $\mathbb{S}$, ams align ]
